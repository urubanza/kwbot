          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <!-- Modal -->
            <div class="modal fade" id="exampleModalvvv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Path list </h5>
            ...
            <script>
                $("#PATHLOADERS").click( function(PATHLOADERS){
                    PATHLOADERS.preventDefault();
                    $.post("functions/SOP/php/pathLists.php",
                           "bns=mn",
                           function(PATHLOADERSx){
                        $("#exampleModalvvv .modal-body").html(PATHLOADERSx);
                    })
                })
            </script>
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"> Active Robots </h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Transport
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Multimedia
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Not active
                    </span>
                  </div>
                </div>
              </div>

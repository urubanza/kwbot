...
import com.pip.sensorskwbot.customview.AutoFitSurfaceGlView;
...
//    } else
    if (videoView instanceof AutoFitSurfaceGlView) {
  ...
  private void handleBotEvents() {
    BotToControllerEventBus.subscribe(
        this::send, error -> pTimber.d("Error occurred in BotToControllerEventBus: %s"));
  }

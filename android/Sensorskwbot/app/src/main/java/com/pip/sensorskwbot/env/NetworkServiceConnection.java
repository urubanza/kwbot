...
import static com.pip.sensorskwbot.utils.pTimber.d;
import static com.pip.sensorskwbot.utils.pTimber.e;
import static com.pip.sensorskwbot.utils.pTimber.i;
  ...
  NsdManager.DiscoveryListener createDiscoveryListener() {
    return new NsdManager.DiscoveryListener() {
      ...
      public void onDiscoveryStopped(String serviceType) {
        i("Discovery stopped: %s");
      }

      @SuppressLint("TimberArgCount")
      @Override
      public void onStartDiscoveryFailed(String serviceType, int errorCode) {
        //e(TAG, "Discovery failed: Error code: %s");

...
import com.pip.sensorskwbot.MainActivity;
import com.pip.sensorskwbot.env.ConnectionUtils;
...
public class NearbyConnection implements ILocalConnection {
      ...
      new EndpointDiscoveryCallback() {
        ...
        public void onEndpointFound(
          ...
          connectionsClient
              ...
              .addOnSuccessListener(unusedResult -> pTimber.d("Connected OK"))
              .addOnFailureListener(
                  e -> {
                    pTimber.d("Unable to connect: Error: %s", e.toString());

                    if (e.getMessage().contains("8012: STATUS_ENDPOINT_IO_ERROR")) {
                      // retry. this usually helps...
                      pTimber.d("Got 8012. Reconnecting...");
        ...
        public void onEndpointLost(@NonNull String endpointId) {
          pTimber.i("onEndpointLost: endpoint lost");
          discovery.cancel();
          stopDiscovery();
        }
      };
  ...
  private final ConnectionLifecycleCallback connectionLifecycleCallback =
      new ConnectionLifecycleCallback() {
        ...
        public void onConnectionInitiated(
          ...
          pTimber.i("onConnectionInitiated: accepting connection");
        ...
        public void onConnectionResult(@NonNull String endpointId, ConnectionResolution result) {
          if (result.getStatus().isSuccess()) {
            pTimber.i("onConnectionResult: connection successful");
            beep();
            Toast.makeText(
            ...
            pTimber.i("onConnectionResult: connection failed");
            isConnected = false;
            Toast.makeText(
                    MainActivity.getContext(),
        ...
        public void onDisconnected(@NonNull String endpointId) {
          ...
          Toast.makeText(
                  ...
                  Toast.LENGTH_LONG)
              .show();
          pTimber.i("onDisconnected: disconnected from the opponent");
  ...
  private void startDiscovery() {
    ...
    connectionsClient
        ...
        .addOnSuccessListener(unusedResult -> pTimber.d("We started discovery OK"))
        .addOnFailureListener(
            e -> pTimber.d("We were unable to start startDiscovery. Error: %s", e.toString()));
    Toast.makeText(
            MainActivity.getContext(),
  ...
  public void sendMessage(String message) {
    if (connectionsClient == null) {
      pTimber.d("Cannot send...No connection!");
      return;
    }
    try {
      ...
      pTimber.d(t, "Something went wrong while sending");
    }
  }

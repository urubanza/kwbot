...
import static com.pip.sensorskwbot.utils.Constants.PERMISSION_AUDIO;
import static com.pip.sensorskwbot.utils.Constants.PERMISSION_CAMERA;
import static com.pip.sensorskwbot.utils.Constants.PERMISSION_LOCATION;
import static com.pip.sensorskwbot.utils.Constants.PERMISSION_STORAGE;
import static com.pip.sensorskwbot.utils.Constants.REQUEST_CAMERA_PERMISSION;
import static com.pip.sensorskwbot.utils.Constants.REQUEST_CONTROLLER_PERMISSIONS;
import static com.pip.sensorskwbot.utils.Constants.REQUEST_LOGGING_PERMISSIONS;
...
public class PermissionUtils {
  ...
  public static void showControllerPermissionsToast(Activity activity) {
    ...
    if (shouldShowRational(activity, PERMISSION_LOCATION)) {
    ...
    if (shouldShowRational(activity, PERMISSION_CAMERA)) {
  ...
  public static void showLoggingPermissionsToast(Activity activity) {
    ...
    if (shouldShowRational(activity, PERMISSION_STORAGE)) {

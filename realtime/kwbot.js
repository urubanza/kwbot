...
//var proxyServer = require("./lib/kwbot/brigde").proxy("192.168.1.77","8000");

var androidServer = require("./android");
...
androidServer.server(8000, function(android){

    android.on("message", function(data){
...
// proxyServer.Connected( function(master){
//     console.log(master);
//     master.onMessage( function(message){
//         console.log(message);
//     });
// });
